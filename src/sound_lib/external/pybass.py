...
BASS_ChannelSetAttributeEx = func_type(ctypes.c_byte, ctypes.c_ulong, ctypes.c_ulong, ctypes.c_void_p, ctypes.c_ulong)(('BASS_ChannelSetAttributeEx', bass_module))
